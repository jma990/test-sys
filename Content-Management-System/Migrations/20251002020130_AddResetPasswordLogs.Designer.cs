...
namespace Content_Management_System.Migrations
{
    ...
    [Migration("20251002020130_AddResetPasswordLogs")]
    partial class AddResetPasswordLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Content_Management_System.Data.ResetPasswordLog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Content_Management_System.Data.ResetPasswordLog", b =>
                {
                    b.HasOne("Content_Management_System.Data.User", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Content_Management_System.Data.User", "TargetUser")
                        .WithMany()
